...
OpenJ9 receives 16 fixed warmup rounds and, only while still improving, up to sixteen bounded
confirmation rounds. Throughput trend, dispersion, p99, error, and memory limits remain unchanged.

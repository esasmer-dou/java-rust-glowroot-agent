...
The runner uses calibrated, deterministic CPU roles instead of selecting an arbitrary idle core.
OpenJ9 receives 16 fixed warmup rounds and, only while still improving, up to eight bounded

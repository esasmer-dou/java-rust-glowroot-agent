...
Rust-Java REST `4.5.3` already contains the embedded runtime. It needs no starter. Add the small
...
| Native platform | Windows x64 or Linux glibc x64 from the clean `rust-spring v4.5.3` revision |

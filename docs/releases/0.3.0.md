...
removes per-sample Docker startup noise. The normal release gate uses three independent JVM pairs;
the optional extended qualification uses six. Throughput trend, dispersion, p99, error, and memory

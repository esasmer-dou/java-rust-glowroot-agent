...
> Historical evidence only. This candidate was superseded by stable `0.2.1`, coordinated with
> Rust-Java REST `4.4.0` native ABI `28`. Do not use this version for new deployments.
